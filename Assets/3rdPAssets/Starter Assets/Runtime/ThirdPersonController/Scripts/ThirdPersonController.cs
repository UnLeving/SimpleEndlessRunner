...
namespace _3rdPAssets.Starter_Assets.Runtime.ThirdPersonController.Scripts
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        private int _animIDHitObstacle;
        ...
        private void PlayerOnOnHitObstacle()
        {
            ...
            _animator.SetTrigger(_animIDHitObstacle);
        }
        ...
        private void AssignAnimationIDs()
        {
            ...
            _animIDHitObstacle = Animator.StringToHash("HitObstacle");
        }
